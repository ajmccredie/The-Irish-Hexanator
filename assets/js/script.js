...
/*function gentext() {
    ...
    let phraseListTwo = ["massive", "no good", "low down", "stinky", "unbearable", "foolish"];
...
function gentext() {
    ...
    thirdPhrase.innerHTML = phraseLisThree[Math.floor(Math.random()*phraseListThree.length)];
}*/
